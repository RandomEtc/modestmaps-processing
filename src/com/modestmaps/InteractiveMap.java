...
public class InteractiveMap implements PConstants {
    ...
    // loading tiles
    public Hashtable<Coordinate, TileLoader> pending = new Hashtable<Coordinate, TileLoader>(); // coord -> TileLoader
    // loaded tiles
    public Hashtable<Coordinate, PImage> images = new Hashtable<Coordinate, PImage>();  // coord -> PImage
    // coords waiting to load
    public Vector<Coordinate> queue = new Vector<Coordinate>();
    // a list of the most recent MAX_IMAGES_TO_KEEP PImages we've seen
    public Vector<PImage> recentImages = new Vector<PImage>();
